...
import { removeUser } from '../services/common';
...
const pages = ['Home', 'Services', 'Products','ContactUs','Signup','SignIn'];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
                <nav>
               <Link to={`/${page}`} style={{padding:'10px' , textDecoration:"none"}}>{page}</Link>
               </nav>
            ))}
...
{/* <nav>
      ...
      */}
               ...
               <nav>
               <a href="#" style={{textDecoration:"none"}} onClick={logoutUser}>Logout</a>
               </nav>
        </Toolbar>
      </Container> 
    </AppBar>
